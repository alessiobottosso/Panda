...
.body(function() {
    ...
    game.createScene('Outro',
    {
        ...
        init: function() 
    	{
            ...
            if(RF_KDHPGVHHRBNCIMSTXJSI)
                this.score = RF_KDHPGVHHRBNCIMSTXJSI;
    	...
    	shareGame:function()
    	{
            ...
            try
            {
                if(app_juve)
                {
                    app_juve.shareCard(RF_KDHPGVHHRBNCIMSTXJSI,
                     game.selectIdx, game.gname, RF_MFSIZQHHEWQNGIQMLNZR);
                }
            }
            catch(ex)
            {
