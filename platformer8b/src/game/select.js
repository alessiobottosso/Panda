...
.body(function() {
    ...
    game.createScene('Select', 
    {
        ...
        init: function() 
    	{
            ...
            this.text = CreateText("Bernardeschi",HALF_WIDTH,
            ...
            var confirm = GetLocalizedString("CONFIRM");
    	...
    	plotSelectedImg: function()
    	{
            ...
            this.selectIdx = 1+this.x+this.y*6;
            ...
            this.text.setText(game.gnames[this.selectIdx-1]);
            this.text.x = 150 + HALF_WIDTH - this.text.width/2
    	...
    	start: function()
    	{
    	   ...
    	   // }
    	    ...
    	    game.gname = game.gnames[this.selectIdx-1];
    	    GoToScene('Tutorial');
    	    //GoToScene('Main');
    	},
    	select: function(x, y)
